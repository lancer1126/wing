...
public class OrderCloseRabbitConfig {
    ...
    public Queue orderDelayQueue() {
        ...
        args.put("x-message-ttl", 50 * 1000L);
        return new Queue(ORDER_ClOSE_ROUTING_KEY, true, false, false, args);
    }
    ...
    public Binding orderDelayQueueBinding() {
        return new Binding(ORDER_CLOSE_DELAY_QUEUE, Binding.DestinationType.QUEUE,
                ORDER_EXCHANGE, ORDER_CLOSE_DELAY_ROUTING_KEY,
                null);
    }
    ...
    public Binding orderCloseQueueBinding() {
        return new Binding(ORDER_ClOSE_QUEUE, Binding.DestinationType.QUEUE,
                ORDER_DLX_EXCHANGE, ORDER_ClOSE_ROUTING_KEY,
                null);
    }
}
